...
module.exports = {
    ...
    exec: async (msg, args) => {
        ...
        if (args.length) {
            ...
            return msg.channel.send(util.embed().setDescription("<a:unchecked:865931554650718249> Missing args."));
        }
        ...
        try {
            ...
            if (e.message === "Sorry I couldn't find that song's lyrics") msg.channel.send(util.embed().setDescription(`<a:unchecked:865931554650718249> ${e.message}`));
